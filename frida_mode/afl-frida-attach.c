 ...
 *
 *gcc -static-libgcc -fPIC -m64 -ffunction-sections -fdata-sections -Wall -Os -pipe -g3 afl-frida-attach.c -o afl-frida-attach -L. -lfrida-core -ldl -lm -ldl -lm -ldl -lrt -ldl -lrt -ldl -ldl -lresolv -ldl -lrt -lm -Wl,--export-dynamic -Wl,--gc-sections,-z,noexecstack -pthread
...
main (int argc, char * argv[])
{
  ...
  g_print (" >> Try to attach to %d on %s\n", target_pid, frida_device_get_name (local_device));
